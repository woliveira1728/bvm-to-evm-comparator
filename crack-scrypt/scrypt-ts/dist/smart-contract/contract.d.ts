...
export declare class SmartContract {
   ...
   */
    ...
    */
    ...
    static dummyUTXOon(feeUTXO: UTXO): Promise<MultiContractTransaction>;

    static dummyNSeqOn(value: number): Promise<MultiContractTransaction>;

    static dummyAutoPayFee(value: boolean): Promise<MultiContractTransaction>;
