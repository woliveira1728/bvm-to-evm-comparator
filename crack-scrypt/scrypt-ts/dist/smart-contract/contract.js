...
let dummyUtxoFlag = false

let dummyAutoPayFee = true
    ...
    */
    ...
    _prepareArgsForMethodCall(methodName, ...args) {
        ...
        let methodCallOptions = {
            ...
            exec: true,
            autoPayFee: dummyAutoPayFee,//true,
    ...
    singleContractCall(methodName, methodCallOptions, methodArgs, sigArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const autoPayFee = dummyAutoPayFee;//methodCallOptions.autoPayFee === undefined || methodCallOptions.autoPayFee === true;
    ...
    signSingleCallTx(tx, inputIndex, defaultAddress, methodCallOptions, methodName, methodArgs, sigArgs) {
        //Jesus is the Lord
        if(dummyNSeq > -1){
            tx.setInputSequence(1,dummyNSeq);
        }
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sigRequests = tx.inputs.flatMap((input, idx) => {
                ...
                if (!dummyAutoPayFee && idx !== inputIndex) {
                    return undefined;
                }
                if (idx === inputIndex) {
    ...
    */
    static multiContractCall(partialContractTx, feeSigner, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const autoPayFee = dummyAutoPayFee;//options.autoPayFee;
            const address = yield feeSigner.getDefaultAddress();
    ...
    static dummyUTXOon(feeUtxo) {
        dummyUTXO = feeUtxo;
        dummyUtxoFlag = true;
    }

    static dummyNSeqOn(value) {
        dummyNSeq = value;
    }

    static dummyAutoPayFee(value) {
        dummyAutoPayFee = value;
    }
    ///////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////
    ...
    static autoPayfee(tx, feePerKb, signer, address, additional = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log("feeUtxos2: ", dummyUTXO);
            if(dummyUtxoFlag){
                feeUtxos = dummyUTXO;
                dummyUtxoFlag = false;
            }
            console.log("feeUtxos2: ", feeUtxos);
            tx.from(feeUtxos);
